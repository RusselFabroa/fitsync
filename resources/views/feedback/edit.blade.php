...
<div class="px-60 mt-8 font-poppins bg-white">
    ...
    <h2 class="pt-4 text-2xl font-poppins font-bold mb-4">Update Feedback Details</h2>
        ...
        <form action="{{ route('feedback.update', $feedback->feedback_id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="user_id" id="user_id" value="{{ old('user_id', $feedback->user_id) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="feedback_content" id="feedback_content"
                    value="{{ old('feedback_content', $feedback->feedback_content) }}"
                    class="mt-1 p-2 w-full border rounded">
