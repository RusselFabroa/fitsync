...
<div class="px-60 mt-8 font-poppins bg-white">
    ...
    <h2 class="pt-4 text-2xl font-poppins font-bold mb-4">Add an Exercise</h2>
        ...
        <form action="{{ route('exercises.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="exercise_name" id="exercise_name" value="{{ old('exercise_name') }}" class="mt-1 p-2 w-full border rounded">
                @error('exercise_name')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="exercise_reps" id="exercise_reps" value="{{ old('exercise_reps') }}" class="mt-1 p-2 w-full border rounded">
                @error('exercise_reps')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="exercise_sets" id="exercise_sets" value="{{ old('exercise_sets') }}" class="mt-1 p-2 w-full border rounded">
                @error('exercise_sets')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
