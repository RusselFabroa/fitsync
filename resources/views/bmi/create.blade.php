...
<div class="max-w-2xl mx-auto mt-10">
    <div class="bg-white p-6 rounded shadow">
        <h2 class="text-2xl font-semibold mb-4">Add Client's BMI</h2>
        ...
        <form action="{{ route('bmi.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="bmi_height" id="bmi_height" value="{{ old('bmi_height') }}" class="mt-1 p-2 w-full border rounded">
                @error('bmi_height')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="bmi_weight" id="bmi_weight" value="{{ old('bmi_weight') }}" class="mt-1 p-2 w-full border rounded">
                @error('bmi_weight')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
